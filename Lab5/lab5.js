...
if (name1.length > name2.length && name1.length > name3.length){
    ...
    console.log(name2 + " has a longer name than " + name1 + ".")
} else if (name1.length = name2.length){
    name1 + "and" + name2 + " have a name that is the same length."
} else if (name1.length = name3.length){
    name1 + "and" + name3 + " have a name that is the same length."
} else if (name2.length = name3.length){
    name2 + "and" + name3 + " have a name that is the same length."
} else {
